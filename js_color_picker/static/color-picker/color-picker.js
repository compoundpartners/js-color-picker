jQuery(document).ready(function($){
    ...
    $('.color-picker-wrap').each(function(){
            ...
            var $active = '';
                if(self.children(".color-picker").val().toUpperCase()==obj.toUpperCase()){
                        ...
                        if(self.children(".color-picker").hasClass('cp-show')){
                            ...
                            self.append('<small>Selected Color: <code>'+obj+'</code></small>');

                        }
                }

                self.children('ul').append('<li '+ $active+' style="background-color:'+obj+'" title="'+ idx+'"></li>');
            });
